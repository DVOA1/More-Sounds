...
public class MoreSoundActions {
    public static List<Map<String, Object>> customSounds = List.of(
            ...
            Map.of("type", "items", "name", "artifacts_night", "keys", List.of("artifacts:night_vision_goggles"), "sound", "more_sound:item.night_vision", "pitch", 1.0, "volume", 0.2),
            Map.of("type", "items", "name", "artifacts_skull", "keys", List.of("artifacts:obsidian_skull"), "sound", "more_sound:item.dark_magic", "pitch", 1.5, "volume", 0.2),
