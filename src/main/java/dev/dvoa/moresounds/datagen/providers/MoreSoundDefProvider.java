    ...
    public void registerSounds() {
        ...
        add(MoreSoundsSoundRegistry.BOTTLED_INK_SLOSH, SoundDefinition.definition()
                .with(
                        ...
                        sound("more_sounds:inks/slosh02", SoundDefinition.SoundType.SOUND).preload(true),
                        sound("more_sounds:inks/slosh03", SoundDefinition.SoundType.SOUND).preload(true),
                        sound("more_sounds:inks/slosh04", SoundDefinition.SoundType.SOUND).preload(true),
                        sound("more_sounds:inks/slosh05", SoundDefinition.SoundType.SOUND).preload(true)
                )
        ...
        add(MoreSoundsSoundRegistry.METAL_BOX_EMPTY, SoundDefinition.definition()
                .with(
                        sound("more_sounds:metal/box/empty01", SoundDefinition.SoundType.SOUND).preload(true),
                        sound("more_sounds:metal/box/empty02", SoundDefinition.SoundType.SOUND).preload(true),
                        sound("more_sounds:metal/box/empty03", SoundDefinition.SoundType.SOUND).preload(true),
                        sound("more_sounds:metal/box/empty04", SoundDefinition.SoundType.SOUND).preload(true),
                        sound("more_sounds:metal/box/empty05", SoundDefinition.SoundType.SOUND).preload(true)
                )
        ...
        add(MoreSoundsSoundRegistry.METAL_BOX_FULL, SoundDefinition.definition()
                .with(
                        sound("more_sounds:metal/box/full01", SoundDefinition.SoundType.SOUND).preload(true),
                        sound("more_sounds:metal/box/full02", SoundDefinition.SoundType.SOUND).preload(true),
                        sound("more_sounds:metal/box/full03", SoundDefinition.SoundType.SOUND).preload(true),
                        sound("more_sounds:metal/box/full04", SoundDefinition.SoundType.SOUND).preload(true),
                        sound("more_sounds:metal/box/full05", SoundDefinition.SoundType.SOUND).preload(true)
                )
        ...
        add(MoreSoundsSoundRegistry.CARDBOARD_BOX, SoundDefinition.definition()
                .with(
                        sound("more_sounds:cardboard/cardboard01", SoundDefinition.SoundType.SOUND).preload(true),
                        sound("more_sounds:cardboard/cardboard02", SoundDefinition.SoundType.SOUND).preload(true),
                        sound("more_sounds:cardboard/cardboard03", SoundDefinition.SoundType.SOUND).preload(true),
                        sound("more_sounds:cardboard/cardboard04", SoundDefinition.SoundType.SOUND).preload(true),
                        sound("more_sounds:cardboard/cardboard05", SoundDefinition.SoundType.SOUND).preload(true)
                )
